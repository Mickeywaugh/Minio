...
class Request
{
     ...
     * @return $this
     */
    public function setFileContents($file): self
    {
        if (is_resource($file)) {
     ...
     * @return $this
     */
    public function sign($access_key, $secret_key): self
    {
     ...
     * @return $this
     */
    public function setMultiCurl($mh): self
    {
        $this->multi_curl = $mh;
        return $this;
    }
     ...
     * @return $this
     */
    public function setCurlOpts($curl_opts): self
    {
